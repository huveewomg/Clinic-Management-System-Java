			...
			if (confirm == JOptionPane.YES_OPTION) {
				try {
					...
					if (!usernameFound) {
						...
						BufferedWriter writer = new BufferedWriter(new FileWriter("C:/Users/timot/Desktop/AndroidStudioProjects/GitHub/Java-Assignment/Java Assignment/credentials.txt"));
